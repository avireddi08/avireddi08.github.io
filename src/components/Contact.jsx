...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        'service_u8can24',   // 🔹 Replace with your EmailJS Service ID
        'template_taojmw6',  // 🔹 Replace with your Template ID
        form.current,
        'AwYeQqC5UV9Fd-Ja-'    // 🔹 Replace with your Public Key
      )
      .then(
        (result) => {
      ...
      <div className="flex flex-col items-center gap-4 mt-8">
        <div className="flex items-center gap-2 text-gray-200">
          ...
          <a href="mailto:avireddi15@gmail.com" className="hover:text-accent transition">
            avireddi15@gmail.com
          </a>
        </div>
        <div className="flex items-center gap-6 mt-2">
          <a
            href="https://www.linkedin.com/in/avishka-reddi08"
            target="_blank"
